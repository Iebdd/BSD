...
\begin{document}
	...
	Bei der Kostenträgerrechnung wird zugerechnet, welcher Abteilung zu welchem Zeitpunkt welche Kosten angefallen sind.
	\subsection{Kostenträgerzeitrechnung}
	Hierbei wird eine Abrechnungsperiode überprüft, die Kostenarten ermittelt und den Kostenträgern zugeteilt.
	\subsubsection{Kostenträgerstückrechnung}
	Die Kostenträgerstückrechnung versucht den kostendeckenden Preis zu bestimmen. Dabei muss man die Marktmacht des Unternehmens betrachten. \\
	Bei Hoher Marktmacht, wenn man zum Beispiel ein Monopol oder einen sehr konzentrierten Markt hat, kann der Kostendeckende Preis eventuell selbst bestimmt werden.
	Bei geringer Marktmacht hat ein Unternehmen wenig bis gar keinen Einfluss auf den Preis und muss sich größtenteils an den Markt anpassen \\
