...
\begin{document}
	...
	\subsection{SD-WAN}
	Das SD-WAN (Software Defined Wide Area Network) ist die Weiterentwicklung des MPLS und wird heutzutage von praktisch allen Anbietern unterstützt. Dabei wird die Konfiguration des Netzwerks, sobald man sich darin einklinkt, automatisch heruntergeladen und konfiguriert. Daten werden dabei zwischen den Standorten per VPN übertragen. Durch die reine Softwarelösung und automatisierte Installation ist es im Vergleich zu MPLS bedeutend preiswerter. Da es jedoch über das reguläre Internet läuft, muss man die geringere Paketgröße von VPNs und eine etwas höhere Latenz gegenüber MPLS in Kauf nehmen.
