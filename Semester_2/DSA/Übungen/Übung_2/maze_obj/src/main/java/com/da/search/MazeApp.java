...
public class MazeApp {
        ...
        switch (args.length) {
            case 0 ->                 {
                    ...
                    for (int i = 1; i < 21; i++) {
                        ...
                        solutionPath= solve(maze, maze.getStart(), maze.getEnd());
            ...
            case 2 -> {
                ...
                System.out.println(maze.toString());
                solve(maze, maze.getStart(), maze.getEnd());
            }
            default -> {
     ...
     * @param start The cell object the maze starts at
     * @param end   The cell object the maze ends at
     * 
     * @return A maze with the solution path marked or an empty string if none was found
     */
    public static String solve(Maze maze, Cell start, Cell end) {
        try {
            //TODO call your searchAlgorithm
            DummyClass searchAlgorithm = new DummyClass(maze);
            List<Cell> solution = searchAlgorithm.solve(start, end);
